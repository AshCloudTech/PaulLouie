...
<head>
    <meta charset="UTF-8">
    <title>Contact || Paul Louie || Responsive HTML 5 Template</title>
...
">
                            ...
                            <form id="contact-form" name="contact_form" class="default-form" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-box">
                                            <select name="windows" class="selectmenu">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-box">
                                            <select name="house_type" class="selectmenu">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>How many storeys?</label>
                                        <div class="input-box">
                                            <select name="storeys" class="selectmenu">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>Conservatory / Extension?</label>
                                        <div class="input-box">
                                            <label><input type="radio" name="conservatory" value="Yes"> Yes</label>
                                            &nbsp;&nbsp;
                                            <label><input type="radio" name="conservatory" value="No"> No</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="input-box">
                                            <select name="one_off_clean" class="selectmenu">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>One-off clean or regular maintenance?</label>
                                        <div class="input-box">
                                            <select name="maintenance_type" class="selectmenu">
                                                <option>One-off Clean</option>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="button-box">
                                            ...
                                            <button class="btn-one" type="submit" data-loading-text="Please wait...">Enquire Now</button>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        document.getElementById("contact-form").addEventListener("submit", function(e) {
            ...
            const form = this;
            const btn = form.querySelector("button[data-loading-text]");
